...
function start() {
    inquirer
        .prompt({
            type: "list",
            name: "action",
            message: "Greetings cooperate overlord. How may I help you?",
            choices: [
...
function addDepartment() {
    inquirer
        .prompt({
            type: "input",
            name: "name",
            message: "Please restructure us by adding a new department:",
        })
        .then((answer) => {
            ...
            inquirer
                .prompt([
                    ...
                    },
                    {
                        type: "list",
                        name: "employee",
                        message: "Select a employee to add a manager to:",
